...
public class HomeController {
    ...
    public ResponseEntity<List<CategoryMaster>> getSubcategories(@PathVariable("parentName") String parentName) {
    ...
    @GetMapping("/cat/{ctgId}/")
    @Transactional(readOnly = true)
    public ResponseEntity<List<PackageMaster>> getPackagesByCategory(@PathVariable("ctgId") String ctgId) {
